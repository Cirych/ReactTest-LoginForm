...
import { Form, FormGroup, Col, FormControl, Button, Glyphicon } from 'react-bootstrap/lib';
...
class LoginForm extends Component {
	...
	render() {
		...
		const success = (
			<span className="LoginForm-success"><Glyphicon glyph="ok" className="LoginForm-Ok" /> Succesful logged</span>
		);
