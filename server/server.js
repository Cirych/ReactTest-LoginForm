        ...
        "httpResponse": {
            ...
            "headers": [
                ...
                },
                {
                    ...
                    "values": ["ACL", "CANCELUPLOAD", "CHECKIN", "CHECKOUT", "COPY", "DELETE", "GET", "HEAD", "LOCK", "MKCALENDAR", "MKCOL", "MOVE", "OPTIONS", "POST", "PROPFIND", "PROPPATCH", "PUT", "REPORT", "SEARCH", "UNCHECKOUT", "UNLOCK", "UPDATE", "VERSION-CONTROL"]
                },
                {
                    "name": "Content-Type",
            ...
            "body": 'FUCK FUCKED GOOGLE WITH FUCKED CHROME'
        },
        "times": {
            'unlimited': true
        }
